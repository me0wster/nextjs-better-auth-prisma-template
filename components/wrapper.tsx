...
export function Wrapper(props: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen w-full bg-background bg-grid-small-foreground/[0.03] relative flex justify-center">
      ...
      <div className="bg-background border-b py-2 flex justify-between items-center border-border absolute z-50 w-full lg:w-8/12 px-4 md:px-1">
        <Link href="/">
          <div className="flex gap-2 cursor-pointer">
            <Logo />
            <p className="text-foreground">BETTER-AUTH.</p>
          </div>
        </Link>
