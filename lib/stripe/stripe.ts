...
export const createCustomerUserRoute = createEndpoint(
...
export const createCustomerOrganizationRoute = createEndpoint(
...
export const getActiveSubscriptionRoute = createEndpoint(
  ...
  async (ctx) => {
    ...
    const customer = await prisma.customer.findFirst({
      where: {
        OR: [{ userId: id }, { organizationId: id }],
      },
    });
...
export const createCheckoutSessionRoute = createEndpoint(
  ...
  async (ctx) => {
    ...
    const customer = await prisma.customer.findFirst({
      where: {
        OR: [{ userId: customerId }, { organizationId: customerId }],
      },
    });
    if (!customer) throw new Error("Customer not found");
...
export const createPortalSessionRoute = createEndpoint(
...
export const getPricingRoute = createEndpoint(
  "/pricing",
  {
    method: "GET",
  },
